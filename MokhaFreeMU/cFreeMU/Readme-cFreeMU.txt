...
2. Use the macro "EnableFreeMovement" in beginning event of the chapter, then you can enter the FreeMovement proc. Free movement is forcefully enabled on base chapters.
...
4. A global flag, ChangeControlledUnitFlag in FreeMovement.event, needs to be set to allow changing the controlled unit.
